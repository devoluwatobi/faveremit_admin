...
/// to also has a [VeridoModalNavigationBar] or a [CupertinoSliverNavigationBar]
...
///
/// By default, only one [VeridoModalNavigationBar] or [CupertinoSliverNavigationBar]
...
/// This example shows a [VeridoModalNavigationBar] placed in a [CupertinoPageScaffold].
...
class VeridoModalNavigationBar extends StatefulWidget implements ObstructingPreferredSizeWidget {
  /// Creates a navigation bar in the iOS style.
  const VeridoModalNavigationBar({
    Key? key,
    this.leading,
  ...
  ///
  /// Defaults to a common tag between all [VeridoModalNavigationBar] and
  ...
  @override
  _VeridoModalNavigationBarState createState() {
    return _VeridoModalNavigationBarState();
  }
}
...
class _VeridoModalNavigationBarState extends State<VeridoModalNavigationBar> {
...
///
/// Like [VeridoModalNavigationBar], it also supports a [leading] and [trailing]
...
/// See also:
///
///  * [VeridoModalNavigationBar], an iOS navigation bar for use on non-scrolling
///    pages.
...
/// A nav bar back button typically used in [VeridoModalNavigationBar].
///
/// This is automatically inserted into [VeridoModalNavigationBar] and
