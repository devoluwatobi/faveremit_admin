...
class Country {
  ...
  factory Country.fromJson(Map<String, dynamic> json) => Country(
        ...
        continentName: continentNameValues.map[json["continentName"]],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "capital": capital,
        "continentName": continentNameValues.reverse[continentName],
      };
}
...
Map<String, dynamic> _countryJson = {
  "countries": {
    "country": [
      {
        "countryCode": "AD",
...
CountryModel countryList = countryModelFromJson(jsonEncode(_countryJson));
