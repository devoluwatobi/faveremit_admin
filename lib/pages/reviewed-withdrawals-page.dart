...
class RevWithdrawalsPage extends StatefulWidget {
  const RevWithdrawalsPage({Key? key}) : super(key: key);

  @override
  _RevWithdrawalsPageState createState() => _RevWithdrawalsPageState();
}

late RefreshController _refreshController;

class _RevWithdrawalsPageState extends State<RevWithdrawalsPage> {
