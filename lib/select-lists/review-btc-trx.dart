import 'package:faveremit_admin/select-lists/failed-btc-trx-reason.dart';
...
class ReviewBitcoinTrxOptionsList extends StatelessWidget {
  final int trxID;
  final bool canApprove;
  const ReviewBitcoinTrxOptionsList({
    Key? key,
    required this.trxID,
                  ...
                  ReviewTrxOption(
                    ...
                    onPressed: () async {
                      await showCupertinoModalBottomSheet(
                        ...
                        builder: (context) {
                          return FailedBitcoinTrxReason(trxID: trxID);
                        },
                      );
                    },
                  ),
