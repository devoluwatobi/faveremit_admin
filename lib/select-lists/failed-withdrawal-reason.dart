...
class FailedWithdrawalReason extends StatefulWidget {
  final int trxID;
  const FailedWithdrawalReason({
    Key? key,
    required this.trxID,
  }) : super(key: key);

  @override
  State<FailedWithdrawalReason> createState() => _FailedWithdrawalReasonState();
}

class _FailedWithdrawalReasonState extends State<FailedWithdrawalReason> {
  @override
  void initState() {
    _reasonID = 0;
                  ...
                  PrimaryTextButton(
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        ProcessError error = await adminWorker.rejectWithdrawal(
                            context: context,
                            id: widget.trxID,
                            reason: _reasonID == 0
                                ? "Fraudulent Activity"
                        ...
                        if (error.any) {
                          ...
                          showInfoModal(
                              ...
                              title: "Success",
                              content:
                                  "Withdrawal Status has been updated sucessfully");
                        }
                      } else {
